...
- 각 그룹별 특징 정리 or 페르소나 부여
    - 0. 평균 30대 중반의 사용 상품이 높으며 활성화 비율이 약 절반인 그룹 : 연차가 어느정도 쌓인 직장인급 주거래 고객(이탈률 낮음)
    - 1. 평균 50대 중반(최고령자)의 사용 상품이 제일 낮으며 가장 많이 활성화된 그룹 : 은퇴 전후 노후계획을 바라보는 고령 고객(이탈률 높음)
    - 2. 평균 40대 초반의 사용 상품이 비교적 낮고 활성화 비율이 가장 낮은 그룹 : 연차가 비교적 많이 쌓인 중견급 직장인(이탈률 높아질 가능성 있음)
    - 3. 평균 20대 중후반의 사용 상품이 높으며 활성화 비율이 약 절반인 그룹 : 사회 초년생(이탈률 낮음)
"""
